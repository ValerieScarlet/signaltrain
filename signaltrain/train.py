...
def eval_status_save(model, effect, epoch, epochs, lr, mom, device, dataloader_val, logfilename, first_time,
    ...
    plot_every=10, cp_every=10, scale_by_freq=None):
    """
    ...
    for x_val, y_val, knobs_val in dataloader_val:
        ...
        #loss_val = loss_functions.error_to_signal(y_val_cuda, y_val_hat)
        ...
        for x, y, knobs in dataloader:
            ...
            if torch_amp and have_apex!=True:
                with autocast():
                    ...
                    # loss evaluation
                    # loss = loss_functions.error_to_signal(y_cuda, y_hat)
